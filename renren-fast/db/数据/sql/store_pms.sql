/*
 ...
 Source Schema         : store_pms

 Target Server Type    : MySQL
 Target Server Version : 50735
 File Encoding         : 65001

 Date: 19/10/2021 17:12:06
*/
...
CREATE TABLE `pms_attr`  (
  ...
  `value_type` tinyint(4) NULL DEFAULT NULL COMMENT '漏掉的 是否可多选的属性0单选1多选',
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (1, '超级好', 1, 1, 'xx', 'aaa;ccc', 0, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (8, '一般好', 0, 0, '2', '1', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (12, '入网型号', 1, 1, 'xxx', 'A2233', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (13, '品牌信息', 1, 1, 'xx', 'a;bb', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (14, '产品名称', 0, 0, 'xx', 'z', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (15, '上市年份', 0, 0, 'xxx', 'z', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (16, '机身颜色', 0, 0, 'xx', 'z', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (17, '机身长度', 0, 0, 'xxx', 'z', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (18, '机身重量', 0, 0, 'xxx', 'z', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (19, 'cpu品牌', 0, 0, 'xxx', 'z', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (20, 'test', 0, NULL, 'aa', '啊啊', 1, 1, 225, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1, 1, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (2, 3, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (3, 4, NULL, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (4, 5, NULL, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (5, 6, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (6, 7, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (7, 9, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (9, 11, NULL, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (10, 12, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (11, 13, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (12, 14, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (13, 15, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (14, 16, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (15, 17, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (16, 18, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (17, 19, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (18, 20, 1, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '属性分组' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (1, '主体', NULL, NULL, NULL, 225);
INSERT INTO `pms_attr_group` VALUES (2, '基本信息', NULL, NULL, NULL, 225);
INSERT INTO `pms_attr_group` VALUES (4, '主芯片', 2, '芯片cpu', 'xx', 225);
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (6, '小米', 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-09/6039fedd-f1e1-4205-805f-5ac10bb4ad6c_1.jpg', '小米', 1, 'X', 0);
INSERT INTO `pms_brand` VALUES (7, 'Apple', 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-13/a36c734b-5a8e-4a03-84df-15e01044fbd7_mical.jpg', '苹果', 1, 'A', 0);
INSERT INTO `pms_brand` VALUES (8, '华为', 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-13/3ebc9abd-9ae1-4d22-829d-1d09087a5e9f_2.jpg', '中国', 1, 'H', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1441 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品三级分类' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category
-- ----------------------------
INSERT INTO `pms_category` VALUES (1, '图书、音像、电子书刊', 0, 1, 1, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (2, '手机', 0, 1, 1, 0, 'xxx', '个', 0);
...
INSERT INTO `pms_category` VALUES (33, '工具类书籍', 1, 2, 1, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (223, '杂志/期刊', 33, 3, 1, 1, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (224, '套装书', 33, 3, 1, 2, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (1433, 'okca', 33, 2, 0, 0, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1434, 'asaaaa', 33, 2, 0, 0, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1435, 'nibu', 33, 2, 0, 0, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1436, 'cacacacaa', 33, 2, 0, 0, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1437, 'q', 33, 3, 0, 6, '', '', NULL);
INSERT INTO `pms_category` VALUES (1438, 'wedqeq', 33, 2, 0, 3, '', '', NULL);
INSERT INTO `pms_category` VALUES (1439, 'wqweqwe', 33, 2, 0, 4, '', '', NULL);
INSERT INTO `pms_category` VALUES (1440, 'weqweq', 33, 2, 0, 5, '', '', NULL);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (9, 6, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (10, 6, 250, '小米', '平板电视');
INSERT INTO `pms_category_brand_relation` VALUES (11, 8, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (12, 7, 225, 'Apple', '手机');
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (1, 3, 12, '入网型号', 'A2233', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (2, 3, 13, '品牌信息', 'a;bb', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (3, 3, 14, '产品名称', 'z', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (4, 3, 15, '上市年份', 'z', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (5, 3, 20, 'test', '啊啊', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (6, 3, 1, '销售', 'aaa;ccc', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (7, 3, 16, '机身颜色', 'z', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (8, 3, 17, '机身长度', 'z', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (9, 3, 18, '机身重量', 'z', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (10, 3, 19, 'cpu品牌', 'z', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (11, 4, 12, '入网型号', 'A2233', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (12, 4, 13, '品牌信息', 'a', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (13, 4, 14, '产品名称', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (14, 4, 15, '上市年份', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (15, 4, 20, 'test', '啊啊', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (16, 4, 1, '超级好', 'aaa;ccc', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (17, 4, 16, '机身颜色', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (18, 4, 17, '机身长度', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (19, 4, 18, '机身重量', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (20, 4, 19, 'cpu品牌', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (21, 5, 12, '入网型号', 'A2233', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (22, 5, 13, '品牌信息', 'a', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (23, 5, 14, '产品名称', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (24, 5, 15, '上市年份', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (25, 5, 20, 'test', '啊啊', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (26, 5, 1, '超级好', 'ccc', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (27, 5, 16, '机身颜色', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (28, 5, 17, '机身长度', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (29, 5, 18, '机身重量', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (30, 5, 19, 'cpu品牌', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (31, 6, 12, '入网型号', 'A2233', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (32, 6, 13, '品牌信息', 'a', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (33, 6, 14, '产品名称', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (34, 6, 15, '上市年份', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (35, 6, 20, 'test', '啊啊', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (36, 6, 1, '超级好', 'aaa', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (37, 6, 16, '机身颜色', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (38, 6, 17, '机身长度', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (39, 6, 18, '机身重量', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (40, 6, 19, 'cpu品牌', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (41, 7, 12, '入网型号', 'A2233', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (42, 7, 13, '品牌信息', 'a', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (43, 7, 14, '产品名称', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (44, 7, 15, '上市年份', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (45, 7, 20, 'test', '啊啊', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (46, 7, 1, '超级好', 'aaa', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (47, 7, 16, '机身颜色', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (48, 7, 17, '机身长度', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (49, 7, 18, '机身重量', 'z', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (50, 7, 19, 'cpu品牌', 'z', NULL, 0);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'sku图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (1, 1, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-14//f1410b18-d952-4480-8c66-edde256e4558_2020010311083818450.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (2, 2, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-14//0c04fcb6-ffa5-4276-823c-08fa1e2b7e5a_2021022210584936766.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (3, 5, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//48f32e90-07a2-4abc-8205-53dabd622a40_59c5e55843c40.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (4, 6, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//48f32e90-07a2-4abc-8205-53dabd622a40_59c5e55843c40.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (5, 7, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//34297563-5be5-4874-81f9-aafd657a28f1_59c5e55843c40.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (6, 8, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//a6c17b40-6359-4509-804f-c514dc7b784a_article-1280x720.11fff394.jpg', NULL, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (1, 3, '华为 aaa 1', NULL, 225, 8, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-14//f1410b18-d952-4480-8c66-edde256e4558_2020010311083818450.png', '华为 aaa 1', '1111', 111111.0000, 0);
INSERT INTO `pms_sku_info` VALUES (2, 3, '华为 ccc 1', NULL, 225, 8, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-14//0c04fcb6-ffa5-4276-823c-08fa1e2b7e5a_2021022210584936766.png', '华为 ccc 1', '11111', 111111.0000, 0);
INSERT INTO `pms_sku_info` VALUES (3, 4, 'se aaa 1 z', NULL, 225, 6, '', 'se aaa 1 z', '更多更多的', 1.0000, 0);
INSERT INTO `pms_sku_info` VALUES (4, 4, 'se ccc 1 z', NULL, 225, 6, '', 'se ccc 1 z', '鼓捣鼓捣鼓捣鼓捣', 1.0000, 0);
INSERT INTO `pms_sku_info` VALUES (5, 5, '1 aaa 1 z', NULL, 225, 6, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//48f32e90-07a2-4abc-8205-53dabd622a40_59c5e55843c40.jpg', '1 aaa 1 z', '111', 10.0000, 0);
INSERT INTO `pms_sku_info` VALUES (6, 5, '1 ccc 1 z', NULL, 225, 6, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//48f32e90-07a2-4abc-8205-53dabd622a40_59c5e55843c40.jpg', '1 ccc 1 z', '1111', 10.0000, 0);
INSERT INTO `pms_sku_info` VALUES (7, 6, '1 aaa 1 z', NULL, 225, 6, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//34297563-5be5-4874-81f9-aafd657a28f1_59c5e55843c40.jpg', '1 aaa 1 z', '11', 1.0000, 0);
INSERT INTO `pms_sku_info` VALUES (8, 7, '2 aaa 1 z', NULL, 225, 8, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//a6c17b40-6359-4509-804f-c514dc7b784a_article-1280x720.11fff394.jpg', '2 aaa 1 z', '222', 220.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (1, 1, 1, '销售', 'aaa', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 1, 8, '12', '1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (3, 2, 1, '销售', 'ccc', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (4, 2, 8, '12', '1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (5, 3, 1, '超级好', 'aaa', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (6, 3, 8, '一般好', '1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (7, 3, 16, '机身颜色', 'z', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (8, 4, 1, '超级好', 'ccc', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (9, 4, 8, '一般好', '1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (10, 4, 16, '机身颜色', 'z', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (11, 5, 1, '超级好', 'aaa', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (12, 5, 8, '一般好', '1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (13, 5, 16, '机身颜色', 'z', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (14, 6, 1, '超级好', 'ccc', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (15, 6, 8, '一般好', '1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (16, 6, 16, '机身颜色', 'z', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (17, 7, 1, '超级好', 'aaa', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (18, 7, 8, '一般好', '1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (19, 7, 16, '机身颜色', 'z', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (20, 8, 1, '超级好', 'aaa', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (21, 8, 8, '一般好', '1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (22, 8, 16, '机身颜色', 'z', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (1, 3, NULL, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-14//f1410b18-d952-4480-8c66-edde256e4558_2020010311083818450.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (2, 3, NULL, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-14//0c04fcb6-ffa5-4276-823c-08fa1e2b7e5a_2021022210584936766.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (3, 3, NULL, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-14//8aa483e6-8aa5-4bbe-8a08-85c941d4eb7b_2021081714114771170.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (4, 4, NULL, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//18c223f0-cd67-4920-8b4a-6dbe519365e1_59c5e55843c40.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (5, 5, NULL, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//48f32e90-07a2-4abc-8205-53dabd622a40_59c5e55843c40.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (6, 6, NULL, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//34297563-5be5-4874-81f9-aafd657a28f1_59c5e55843c40.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (7, 7, NULL, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//a6c17b40-6359-4509-804f-c514dc7b784a_article-1280x720.11fff394.jpg', NULL, NULL);
...
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (1, '好90', '哈', 225, 8, 10.0000, 0, NULL, NULL);
INSERT INTO `pms_spu_info` VALUES (2, 'a', 'a', 225, 7, 110.0000, 0, NULL, NULL);
INSERT INTO `pms_spu_info` VALUES (3, '华为', '手机', 225, 8, 10.0000, 0, '2021-10-14 17:47:06', '2021-10-14 17:47:06');
INSERT INTO `pms_spu_info` VALUES (4, 'se', '我的手机', 225, 6, 1.5000, 0, '2021-10-15 10:08:40', '2021-10-15 10:08:40');
INSERT INTO `pms_spu_info` VALUES (5, '1', '1', 225, 6, 10.5000, 0, '2021-10-15 10:27:28', '2021-10-15 10:27:28');
INSERT INTO `pms_spu_info` VALUES (6, '1', '1', 225, 6, 0.2000, 0, '2021-10-15 10:50:55', '2021-10-15 10:50:55');
INSERT INTO `pms_spu_info` VALUES (7, '2', '2', 225, 8, 0.1000, 0, '2021-10-15 10:54:29', '2021-10-15 10:54:29');
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (3, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-14//f2e42de7-3865-4d08-89d0-eab412c66f60_1.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (4, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//61742515-8eba-4105-8bed-1487443cca51_mical.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (5, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//30b74113-bbcd-45d8-8670-b4680de7a4d5_59c5e55843c40.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (6, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//ac13effa-738d-4024-895f-8a9bc7bc13a5_59c5e55843c40.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (7, 'https://winowis.oss-cn-chengdu.aliyuncs.com/2021-10-15//ce2e48d9-a5d0-4f5f-8081-b23044fa318e_article-1280x720.11fff394.jpg');
