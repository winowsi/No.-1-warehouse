...
public class AttrGroupController {
    ...
    public R AttrGroupListWithAttr(@PathVariable("categoryId") Long categoryId) {
        //1.查出当前分类的所有分组
        //2.查出每个分组的所有属性
        List<AttrGroupWithAttrsVo> vos = attrGroupService.getAttrGroupWithAttrsById(categoryId);
